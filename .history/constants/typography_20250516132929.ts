...
// Font weights (these map to the font file names)const fontWeight = {  regular: '400', // Corresponds to OpenSans-Regular  medium: '500',  // Corresponds to OpenSans-Medium  semiBold: '600',// Corresponds to OpenSans-Semibold  bold: '700',    // Corresponds to OpenSans-Bold};
