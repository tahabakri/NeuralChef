...
import { useRecipeHistoryStore } from '../../stores/recipeHistoryStore';import { useRecipeStore } from '../../stores/recipeStore';import { usePreferencesStore } from '../../stores/preferencesStore';import { Recipe, generateRecipe, RecipeServiceError } from '../../services/recipeService';import colors from '../../constants/colors';import FilterDropdown from '../../components/FilterDropdown';
...
export default function TabOneScreen() {
  ...
  const { history: recipeHistory, clearHistory, addToHistory } = useRecipeHistoryStore();
