            ...
            <View style={styles.sectionHeader}>
              ...
              >
                ...
                <Text style={styles.clearHistoryText}>Clear</Text>
                        ...
                        <FlatList              data={recipeHistory}              horizontal              showsHorizontalScrollIndicator={false}              contentContainerStyle={styles.recentRecipesContainer}              initialNumToRender={3}              maxToRenderPerBatch={3}              windowSize={3}              removeClippedSubviews={Platform.OS !== 'web'}              keyExtractor={(item, index) => item.title + index}
