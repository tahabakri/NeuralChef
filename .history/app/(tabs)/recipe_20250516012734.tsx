...
import { StyleSheet, Text, View, ScrollView, Platform, Pressable, Alert, Share, Animated } from 'react-native';
import { useRouter } from 'expo-router';
import * as Haptics from 'expo-haptics';
import { Image } from 'expo-image';
import { ChevronLeft, Clock, Users, Flame, Heart, Share2, TimerOff, Bookmark, BarChart, Star, ChevronDown, ChevronUp, Coffee, CircleCheck } from 'lucide-react-native';
      ...
      <View style={styles.contentCard}>
        ...
        >
          ...
          <View style={styles.relatedRecipesSection}>
            ...
            >
              {RELATED_RECIPES.map(relatedRecipe => (
                <Pressable 
