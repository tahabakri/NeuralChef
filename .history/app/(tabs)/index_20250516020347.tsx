        ...
        <View style={styles.recentSection}>
          ...
          <View style={styles.recentItems}>
            {recentIngredients.length > 0 ? (
              ...
              />
                          ) : (                <View style={styles.emptyStateContainer}>                  <ExpoImage                     source={require('../../assets/images/empty-basket.png')}                     style={styles.emptyStateImage}                    contentFit="contain"                  />                  <Text style={styles.emptyStateText}>                    Your recently used ingredients will appear here.                  </Text>                  <TouchableOpacity
