    ...
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.contentContainer}>
        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.examplesScroll}>
          {/* Pasta Dinner Card */}
          <Pressable onPress={() => handleExamplePress('pasta, tomatoes, garlic, olive oil, basil')} style={styles.exampleCardContainer}>
            <Card
          ...
          {/* Breakfast Card */}
          <Pressable onPress={() => handleExamplePress('eggs, bread, avocado, cheese, spinach')} style={styles.exampleCardContainer}>
            <Card
              style={styles.exampleCard}
              variant="elevated"
            >
          ...
          {/* Vegetarian Card */}
          <Pressable onPress={() => handleExamplePress('tofu, bell peppers, broccoli, rice, soy sauce, ginger')} style={styles.exampleCardContainer}>
            <Card
              style={styles.exampleCard}
              variant="elevated"
            >
