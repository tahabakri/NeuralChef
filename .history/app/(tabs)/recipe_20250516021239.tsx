        ...
        <View style={styles.actionButtons}>
          ...
          >
            <Share2 size={24} color="white" />
                ...
                {/* Hero title overlay */}        <View style={styles.heroTitleContainer}>          {recipe.category && (            <CategoryTag category={recipe.category} size="small" />          )}          <Text style={styles.heroTitle}>{recipe.title}</Text>          <Text style={styles.heroSubtitle}>{recipe.description}</Text>        </View>
      </View>
