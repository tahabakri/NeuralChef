...
export async function modifyRecipe(
  ...
  try {
    ...
    // Apply dietary preferences to the recipe if needed
      ...
      switch (dietaryPreference) {
        case 'vegetarian':
          ...
          modifiedRecipe.ingredients = modifiedRecipe.ingredients.map(ingredient => {
            ...
            if (lower.includes('beef')) return 'Mushrooms';
            if (lower.includes('pork')) return 'Tempeh';
            if (lower.includes('meat')) return 'Plant-based protein';
            return ingredient;
          });
          break;
        case 'vegan':
          ...
          modifiedRecipe.ingredients = modifiedRecipe.ingredients.map(ingredient => {
            ...
            if (lower.includes('milk')) return 'Almond milk';
        ...
        case 'gluten-free':
          ...
          modifiedRecipe.ingredients = modifiedRecipe.ingredients.map(ingredient => {
            const lower = ingredient.toLowerCase();
            if (lower.includes('flour')) return 'Gluten-free flour';
            if (lower.includes('pasta')) return 'Gluten-free pasta';
            if (lower.includes('bread')) return 'Gluten-free bread';
            if (lower.includes('wheat')) return 'Gluten-free alternative';
            return ingredient;
          });
          break;
      }
