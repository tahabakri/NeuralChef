...
import { View, Text, StyleSheet, Pressable, FlatList, Animated, Platform } from 'react-native';
...
export default function IngredientsList({ ingredients }: IngredientsListProps) {
  ...
  // Function to render an ingredient item
  const renderIngredientItem = ({ item, index }: { item: string; index: number }) => (
    <Pressable 
      style={[
    ...
    >
      ...
      <View style={styles.ingredientTextContainer}>
        {formatIngredient(item, checkedIngredients[index])}
      </View>
    </Pressable>
  );
